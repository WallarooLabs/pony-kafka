...
You want to contribute to Pony Kafka? Awesome.

There are a number of ways to contribute to Pony Kafka. As this document is a little long, feel free to jump to the section that applies to you currently:
...
First of all please [search existing issues][https://github.com/wallaroolabs/pony-kafka/issues] to make sure your issue hasn't already been reported. If you cannot find a suitable issue — [create a new one][https://github.com/WallarooLabs/pony-kafka/issues/new].
...
1. Fork the Pony Kafka repo. you can do this via the GitHub website. This will result in you having your own copy of the Pony Kafka repo under your GitHub account. 
2. Clone your Pony Kafka repo to your local machine
...
If you feel overwhelmed at any point, don't worry, it can be a lot to learn when you get started.
...
```bash
my_command --some-option foo --path-to-file ../../long/line/foo \
...
```bash
my_command --some-option foo --path-to-file ../../long/line/foo --some-other-option bar
```
