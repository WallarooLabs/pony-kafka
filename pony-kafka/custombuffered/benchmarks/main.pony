...
actor Main is BenchmarkList
  ...
  fun tag benchmarks(bench: PonyBench) =>
    ...
    bench(_BasicWriterU8)
    bench(_BasicWriterU16)
    bench(_BasicWriterU32)
    bench(_BasicWriterU64)
    bench(_BasicWriterU128)
    bench(_PartiallyOverwriteableWriterU8)
    bench(_PartiallyOverwriteableWriterU16)
    bench(_PartiallyOverwriteableWriterU32)
    bench(_PartiallyOverwriteableWriterU64)
    bench(_PartiallyOverwriteableWriterU128)
