...
primitive BigEndianEncoder
  ...
  fun u16(wb: Writer, data: U16) =>
    ...
    """
    wb.write_two_bytes((data >> 8).u8(), data.u8())
  ...
  fun u32(wb: Writer, data: U32) =>
    ...
    """
    wb.write_four_bytes((data >> 24).u8(), (data >> 16).u8(),
      (data >> 8).u8(), data.u8())
  ...
  fun u64(wb: Writer, data: U64) =>
    ...
    """
    wb.write_eight_bytes((data >> 56).u8(), (data >> 48).u8(),
      (data >> 40).u8(), (data >> 32).u8(), (data >> 24).u8(),
      (data >> 16).u8(), (data >> 8).u8(), data.u8())
